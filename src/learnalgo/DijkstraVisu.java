 ...
 * @author USER
 */
public class DijkstraVisu extends java.applet.Applet {
    ...
    DijkstraVisu(){}
    DijkstraVisu(Frame f){
        options = new Options(this, f);
    }
    public void init() {
	...
	Frame frame = new Frame("Dijkstra");
        DijkstraVisu g = new DijkstraVisu(frame);
        g.init();
...
// set of options at the right of the screen
    java.awt.Button b1 = new java.awt.Button("clear");
    java.awt.Button b2 = new java.awt.Button("run");
    java.awt.Button b3 = new java.awt.Button("step");
    java.awt.Button b4 = new java.awt.Button("reset");
    java.awt.Button b5 = new java.awt.Button("example");
    java.awt.Button b6 = new java.awt.Button("exit");
    DijkstraVisu parent;   
    boolean Locked=false;
    Frame myJollyFrame = new Frame();
    Options(DijkstraVisu myparent) {
	parent = myparent;
    ...
    Options(DijkstraVisu myparent, Frame f) {
...
//                System.out.println("hi hello pi pi hello hi");
                myJollyFrame.setVisible(false);
                //System.out.println("ami aschi");
...
// drawing area for the graph
    ...
    GraphCanvas(DijkstraVisu myparent) {
	parent = myparent;
	init();
	algorithm=DIJKSTRA;
